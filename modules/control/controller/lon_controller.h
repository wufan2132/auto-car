...
//   //gyl void GetPathRemain(SimpleLongitudinalDebug *debug);

//  private:
//   //gyl void SetDigitalFilterPitchAngle(const LonControllerConf &lon_controller_conf);

//   //gyl void LoadControlCalibrationTable(
//   //gyl     const LonControllerConf &lon_controller_conf);

//   //gyl void SetDigitalFilter(double ts, double cutoff_freq,
//                         common::DigitalFilter *digital_filter);

//   //gyl void CloseLogFile();

//   const localization::LocalizationEstimate *localization_ = nullptr;
//   const canbus::Chassis *chassis_ = nullptr;

//   //gyl std::unique_ptr<Interpolation2D> control_interpolation_;
//   //gyl const planning::ADCTrajectory *trajectory_message_ = nullptr;
//   //gyl std::unique_ptr<TrajectoryAnalyzer> trajectory_analyzer_;

//   std::string name_;
//   //gyl bool controller_initialized_ = false;

//   PIDController speed_pid_controller_;
//   PIDController station_pid_controller_;

//   //gyl FILE *speed_log_file_ = nullptr;

//   //gyl common::DigitalFilter digital_filter_pitch_angle_;

//   const ControlConf *control_conf_ = nullptr;

//   // vehicle parameter
//   //gyl common::VehicleParam vehicle_param_;
// };
// }  // namespace control
// }  // namespace apollo
