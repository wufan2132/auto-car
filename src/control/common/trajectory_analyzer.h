...
class TrajectoryAnalyzer {
 public:
   ...
   * planning module
   */
  TrajectoryAnalyzer(const car_msgs::trajectory *planning_published_trajectory);
   ...
   */
  car_msgs::trajectory_point QueryNearestPointByAbsoluteTime(
   ...
   * @return a point of trajectory
   */
  car_msgs::trajectory_point QueryNearestPointByRelativeTime(
      const double t) const;
   ...
   */
  car_msgs::trajectory_point QueryMatchedPathPoint(const double x,
                                                   const double y) const;
  ...
  void ToTrajectoryFrame(const double x, const double y, const double theta,
                         const double v,
                         const car_msgs::trajectory_point &matched_point,
 ...
 private:
  car_msgs::trajectory_point FindMinDistancePoint(
      const car_msgs::trajectory_point &p0,
      const car_msgs::trajectory_point &p1, const double x,
      const double y) const;
