...
(cl:defclass <lat_debug> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass lat_debug (<lat_debug>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <lat_debug>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'lat_debug)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name car_msgs-msg:<lat_debug> is deprecated: use car_msgs-msg:lat_debug instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <lat_debug>))
...
(cl:defmethod lateral_error-val ((m <lat_debug>))
...
(cl:defmethod ref_heading-val ((m <lat_debug>))
...
(cl:defmethod heading-val ((m <lat_debug>))
...
(cl:defmethod heading_error-val ((m <lat_debug>))
...
(cl:defmethod heading_error_rate-val ((m <lat_debug>))
...
(cl:defmethod lateral_error_rate-val ((m <lat_debug>))
...
(cl:defmethod curvature-val ((m <lat_debug>))
...
(cl:defmethod steer_angle-val ((m <lat_debug>))
...
(cl:defmethod steer_angle_feedforward-val ((m <lat_debug>))
...
(cl:defmethod steer_angle_lateral_contribution-val ((m <lat_debug>))
...
(cl:defmethod steer_angle_lateral_rate_contribution-val ((m <lat_debug>))
...
(cl:defmethod steer_angle_heading_contribution-val ((m <lat_debug>))
...
(cl:defmethod steer_angle_heading_rate_contribution-val ((m <lat_debug>))
...
(cl:defmethod steer_angle_feedback-val ((m <lat_debug>))
...
(cl:defmethod steering_position-val ((m <lat_debug>))
...
(cl:defmethod ref_speed-val ((m <lat_debug>))
...
(cl:defmethod steer_angle_limited-val ((m <lat_debug>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <lat_debug>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <lat_debug>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<lat_debug>)))
  "Returns string type for a message object of type '<lat_debug>"
  "car_msgs/lat_debug")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lat_debug)))
  "Returns string type for a message object of type 'lat_debug"
  "car_msgs/lat_debug")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<lat_debug>)))
  "Returns md5sum for a message object of type '<lat_debug>"
  "8df804ed8187912c1b683d311df460c6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'lat_debug)))
  "Returns md5sum for a message object of type 'lat_debug"
  "8df804ed8187912c1b683d311df460c6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<lat_debug>)))
  "Returns full string definition for message of type '<lat_debug>"
  (cl:format cl:nil "Header header~%~%float64 lateral_error~%float64 ref_heading~%float64 heading~%float64 heading_error~%float64 heading_error_rate~%float64 lateral_error_rate~%float64 curvature~%float64 steer_angle~%float64 steer_angle_feedforward~%float64 steer_angle_lateral_contribution~%float64 steer_angle_lateral_rate_contribution~%float64 steer_angle_heading_contribution~%float64 steer_angle_heading_rate_contribution~%float64 steer_angle_feedback~%float64 steering_position~%float64 ref_speed~%float64 steer_angle_limited~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'lat_debug)))
  "Returns full string definition for message of type 'lat_debug"
  (cl:format cl:nil "Header header~%~%float64 lateral_error~%float64 ref_heading~%float64 heading~%float64 heading_error~%float64 heading_error_rate~%float64 lateral_error_rate~%float64 curvature~%float64 steer_angle~%float64 steer_angle_feedforward~%float64 steer_angle_lateral_contribution~%float64 steer_angle_lateral_rate_contribution~%float64 steer_angle_heading_contribution~%float64 steer_angle_heading_rate_contribution~%float64 steer_angle_feedback~%float64 steering_position~%float64 ref_speed~%float64 steer_angle_limited~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <lat_debug>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <lat_debug>))
