...
(cl:defmethod cl:initialize-instance :after ((m <trajectory_point>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'trajectory_point)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name car_msgs-msg:<trajectory_point> is deprecated: use car_msgs-msg:trajectory_point instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <trajectory_point>))
...
(cl:defmethod theta-val ((m <trajectory_point>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car_msgs-msg:theta-val is deprecated.  Use car_msgs-msg:theta instead.")
  (theta m))

(cl:ensure-generic-function 'kappa-val :lambda-list '(m))
(cl:defmethod kappa-val ((m <trajectory_point>))
...
(cl:defmethod s-val ((m <trajectory_point>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car_msgs-msg:s-val is deprecated.  Use car_msgs-msg:s instead.")
  (s m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <trajectory_point>))
...
(cl:defmethod accel-val ((m <trajectory_point>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car_msgs-msg:accel-val is deprecated.  Use car_msgs-msg:accel instead.")
  (accel m))

(cl:ensure-generic-function 'relative_time-val :lambda-list '(m))
(cl:defmethod relative_time-val ((m <trajectory_point>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car_msgs-msg:relative_time-val is deprecated.  Use car_msgs-msg:relative_time instead.")
  (relative_time m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<trajectory_point>)))
  ...
  "5e311e54de4ba9856b316e2cfa921066")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'trajectory_point)))
  "Returns md5sum for a message object of type 'trajectory_point"
  "5e311e54de4ba9856b316e2cfa921066")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<trajectory_point>)))
  ...
  (cl:format cl:nil "Header header~%~%float64 x~%float64 y~%float64 z~%float64 theta~%float64 kappa~%float64 s~%~%float64 speed~%float64 accel~%~%float64 relative_time~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'trajectory_point)))
  "Returns full string definition for message of type 'trajectory_point"
  (cl:format cl:nil "Header header~%~%float64 x~%float64 y~%float64 z~%float64 theta~%float64 kappa~%float64 s~%~%float64 speed~%float64 accel~%~%float64 relative_time~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
