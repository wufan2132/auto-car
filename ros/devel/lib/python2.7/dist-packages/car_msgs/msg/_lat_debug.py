...
"""autogenerated by genpy from car_msgs/lat_debug.msg. Do not edit."""
import sys
...
class lat_debug(genpy.Message):
  _md5sum = "8df804ed8187912c1b683d311df460c6"
  _type = "car_msgs/lat_debug"
...
string frame_id
"""
  __slots__ = ['header','lateral_error','ref_heading','heading','heading_error','heading_error_rate','lateral_error_rate','curvature','steer_angle','steer_angle_feedforward','steer_angle_lateral_contribution','steer_angle_lateral_rate_contribution','steer_angle_heading_contribution','steer_angle_heading_rate_contribution','steer_angle_feedback','steering_position','ref_speed','steer_angle_limited']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,lateral_error,ref_heading,heading,heading_error,heading_error_rate,lateral_error_rate,curvature,steer_angle,steer_angle_feedforward,steer_angle_lateral_contribution,steer_angle_lateral_rate_contribution,steer_angle_heading_contribution,steer_angle_heading_rate_contribution,steer_angle_feedback,steering_position,ref_speed,steer_angle_limited
    ...
    """
    if args or kwds:
      super(lat_debug, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_17d().pack(_x.lateral_error, _x.ref_heading, _x.heading, _x.heading_error, _x.heading_error_rate, _x.lateral_error_rate, _x.curvature, _x.steer_angle, _x.steer_angle_feedforward, _x.steer_angle_lateral_contribution, _x.steer_angle_lateral_rate_contribution, _x.steer_angle_heading_contribution, _x.steer_angle_heading_rate_contribution, _x.steer_angle_feedback, _x.steering_position, _x.ref_speed, _x.steer_angle_limited))
