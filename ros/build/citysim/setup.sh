...
export GAZEBO_RESOURCE_PATH=/home/wf/my-code/auto-car/ros/install/share/citysim-0/:$GAZEBO_RESOURCE_PATH

# add path to gazebo models from citysim_resources
export GAZEBO_MODEL_PATH=/home/wf/my-code/auto-car/ros/install/share/citysim-0/models:$GAZEBO_MODEL_PATH

# Add the directories containing our Gazebo plugins to GAZEBO_PLUGIN_PATH.
export GAZEBO_PLUGIN_PATH=/home/wf/my-code/auto-car/ros/install/lib/citysim-0/plugins:$GAZEBO_PLUGIN_PATH
